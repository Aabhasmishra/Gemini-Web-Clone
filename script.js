...
const suggestionsElement = document.querySelector(".suggests");
...
const Google_API_Key = "AIzaSyBwR1cHq3Bv1QPgVaj5lWQz6HWNUtoiSaw";
...
const loadSavedChatHistory = () => {
    ...
    // Show/hide header and suggestions based on saved chats
    const hasSavedChats = savedConversations.length > 0;
    if (hasSavedChats) {
        headerElement.classList.add("hide");
        suggestionsElement.classList.add("hide");
        document.body.classList.add("hide-header");
    } else {
        headerElement.classList.remove("hide");
        suggestionsElement.classList.remove("hide");
    ...
    savedConversations.forEach(conversation => {
        ...
        const parsedApiResponse = responseText ? marked.parse(responseText) : "No response available";
